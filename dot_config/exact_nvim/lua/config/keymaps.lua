...
-- vim.keymap.set('n', '<leader>f', function() Snacks.picker.files({ cwd = true }) end, { desc = "Open file picker (cwd)" })
...
vim.keymap.set('n', '<leader>S', function() Snacks.picker.lsp_symbols({ cwd = true }) end,
  { desc = "Open symbol picker (cwd)" })
vim.keymap.set('n', '<leader>?', function() Snacks.picker.commands() end, { desc = "Open command picker" })
vim.keymap.set('n', '<leader>r', function() Snacks.picker.resume() end, { desc = "Resume last search" })
vim.keymap.set('n', '<leader><Space>', function() Snacks.picker.resume() end, { desc = "Resume last search" })
vim.keymap.set('n', '<leader>c', "<cmd>normal gcc<CR>", { desc = "Comment line" })
