...
sudo dnf install libwebkitgtk rust-gtk-sys-devel libproxy-webkitgtk4 webkitgtk4 libsoup libsoup-devel webkitgtk4-devel graphene-devel pango-devel cairo-devel cairomm-devel cairo-gobject --skip-unavailable
```
##### Silverblue
```bash 
# Add the terra repo
