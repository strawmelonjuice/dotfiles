...
```bash
pacman -S gcc cmake fish chezmoi gcc cmake 'g++' 'gcc-c++' wezterm niri hyprpaper hyprlock # chezmoi can be locally installed as well but if we're at it
...
sudo dnf install terra-release fish gcc cmake 'g++' 'gcc-c++' wezterm niri hyprlock hyprpaper brightnessctl krunner
